package com.erivan.s3bucket.service;
...
import static com.erivan.s3bucket.config.AmazonConfig.s3bucketCredentials;

public class ObjectsServices {
    //lista os objetos do bucket informado
    public static void listObjects(String bucketName){
        AmazonS3 s3 = s3bucketCredentials();
